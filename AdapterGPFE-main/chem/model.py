...
class GNN_graphpred(torch.nn.Module):
    ...
    def __init__(self, args, num_layer, emb_dim, num_task=2, JK="last", drop_ratio=0, graph_pooling="mean",
                 gnn_type="gin"):
    ...
    def from_pretrained(self, model_file):
        ...
        self.gnn.load_state_dict(torch.load(model_file, map_location='cuda:2'))
